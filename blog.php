        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="blog__item">
                    <div class="blog__item__pic set-bg" style="background-image: url(&quot;images/blog-1.jpg&quot;);">
                ...
                <div class="blog__item">
                    <div class="blog__item__pic set-bg" style="background-image: url(&quot;images/blog-2.jpg&quot;);">
                        <div class="blog__pic__inner">
                            <div class="label">Recipes</div>
                            <ul>
                                <li>By <span>James Myers</span></li>
                ...
                <div class="blog__item">
                    <div class="blog__item__pic set-bg" style="background-image: url(&quot;images/blog-3.jpg&quot;);">
                        <div class="blog__pic__inner">
                            <div class="label">Recipes</div>
                            <ul>
                                <li>By <span>James Myers</span></li>
                ...
                <div class="blog__item">
                    <div class="blog__item__pic set-bg" style="background-image: url(&quot;images/blog-4.jpg&quot;);">
                        <div class="blog__pic__inner">
                            <div class="label">Recipes</div>
                            <ul>
                                <li>By <span>James Myers</span></li>
                ...
                <div class="shop__pagination">
                    ...
                    <a href="#">2</a>
                    <a href="#">3</a>
                    <a href="#" class="blog-arr"><i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4">
